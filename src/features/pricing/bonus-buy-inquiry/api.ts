...
// owns the two the SCREEN needs: the access probe + the list search. Detail and
// GroupingMembers moved to `@/core/bonus-buy/api` with the modal they feed (ticket
// 112). All are DESIGNED contracts, built later on SIS.Api.
const BASE = 'Bby'
