...
export const MENU: ShellMenuItem[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        // The accountant's settlement account (spec 267 D1, ticket 268) — a FIFTH
        ...
        //
        // 🚩 It shares the ONE key with the four above, so the fifth grant costs no
        // sixth round trip — and it reads `canOpenSettlement`, the same predicate
